...
import project.bzu.csc.Activities.ViewQuestionPost;
import project.bzu.csc.Models.Post;
import project.bzu.csc.Models.User;
import project.bzu.csc.R;


public class GetQuestionPostsAdapter extends RecyclerView.Adapter<GetQuestionPostsAdapter.ViewHolder> {
    ...
    public GetQuestionPostsAdapter(Context context, List<Post> posts){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(context, ViewQuestionPost.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                intent.putExtra("postIDFromQuestion",posts.get(position).getPostID());
